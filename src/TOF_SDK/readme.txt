...
5. 版本更新记录
	...
	5.5【v5.0.0_build20220830_150655_rb4c49e】
		(1) v5.0.0初版；
	5.6【v5.0.0_build20221108_165932_rbdf157】
		(1) 修改传出灰度的类型，统一为u8
	5.7【v5.0.2_build20230201_134215_r606124】
		(1) v5.0.2初版；
		(2) 修改算法
		(3) 更新头文件
	5.8【v5.0.2_build20230210_092909_r36c276】
		(1) 更新配置
	5.9【v5.0.5_build20230522_163458_rc23db0】
		(1) 更新滤波配置
	5.10【v5.0.5_build20230531_171011_r1b48fe】
		(1) 更新滤波参数;
